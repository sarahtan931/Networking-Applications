...
module.exports = {
    ...
    init: function (v, f, responseType, timestamp, sequenceNumber, arrname, arrtype) { // feel free to add function parameters as needed   
        ...
        imageCount = arrname.length;
        //looping through the images and creating a payload for each one
        for (let i = 0; i < imageCount; i++) {
            let imagename = arrname[i];
            let imagetype = arrtype[i];
        ...
        temp1 = this.makeBinaryString(0, v, 0);
